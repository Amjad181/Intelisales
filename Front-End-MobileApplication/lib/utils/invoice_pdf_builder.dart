      ...
      build: (context) => pw.Column(
        ...
        children: [
          ...
          pw.Row(
            ...
            children: [
              ...
              pw.Column(
                ...
                children: [
                  pw.Text('INVOICE', style: pw.TextStyle(font: bold, fontSize: 22)),
                  pw.SizedBox(height: 6),
                  pw.Text('${ar ? "الرقم: " : "NUMBER: "}INV-DRAFT',
                      style: const pw.TextStyle(fontSize: 10)),
                  pw.Text('${ar ? "التاريخ: " : "DATE: "}$dateText',
                      style: const pw.TextStyle(fontSize: 10)),
                ],
              ),
            ],
            ...
            children: [
              ...
              pw.Expanded(
                child: pw.Column(
                  crossAxisAlignment: pw.CrossAxisAlignment.start,
                  children: [
                    pw.Text(ar ? 'طريقة الدفع' : 'PAYMENT',
                        style:
                            pw.TextStyle(font: bold, fontSize: 9, color: PdfColors.grey700)),
                    pw.SizedBox(height: 8),
                    pw.Text(ar ? 'نقداً أو تحويل بنكي' : 'Cash / Bank Transfer',
            ...
            pw.Table(
              ...
              children: [
                pw.TableRow(
                  ...
                  children: [
                    _headerCell(ar ? 'المنتج' : 'PRODUCT', bold, pw.TextAlign.start),
                    _headerCell(ar ? 'الكمية' : 'QTY', bold, pw.TextAlign.center),
                    _headerCell(ar ? 'سعر الوحدة' : 'UNIT PRICE', bold, pw.TextAlign.center),
                    _headerCell(ar ? 'الإجمالي' : 'TOTAL', bold, pw.TextAlign.end),
                  ],
                ),
                for (final item in items)
                  pw.TableRow(
                    children: [
                      ...
                      _cell(formatSYP(item.total, ar), pw.TextAlign.end, font: bold),
                    ],
                  ),
              ],
            ),
          ...
          pw.Container(
            ...
            child: pw.Column(
              children: [
                _totalRow(ar ? 'المجموع الفرعي:' : 'SUBTOTAL', formatSYP(subtotal, ar)),
                pw.SizedBox(height: 6),
                _totalRow(ar ? 'الضريبة (8٪):' : 'TAX (8%)', formatSYP(tax, ar)),
                pw.SizedBox(height: 6),
                _totalRow(ar ? 'الخصم (10٪):' : 'DISCOUNT (10%)',
                ...
                pw.Row(
                  ...
                  children: [
                    pw.Text(ar ? 'الإجمالي الكلي:' : 'TOTAL AMOUNT',
                        style: pw.TextStyle(font: bold, fontSize: 13)),
                    pw.Text(formatSYP(total, ar),
              ...
              pw.Expanded(
                child: pw.Column(
                  children: [
                    ...
                    pw.SizedBox(height: 6),
                    pw.Text(ar ? 'ختم الشركة' : 'Company Seal',
                        style: const pw.TextStyle(fontSize: 9, color: PdfColors.grey700)),
                  ],
                ),
              ),
              ...
              pw.Expanded(
                child: pw.Column(
                  children: [
                    pw.Container(height: 1, color: PdfColors.grey500),
                    pw.SizedBox(height: 6),
                    pw.Text(ar ? 'توقيع الزبون' : 'Customer Signature',
                        style: const pw.TextStyle(fontSize: 9, color: PdfColors.grey700)),
                  ],
                ),
              ),
